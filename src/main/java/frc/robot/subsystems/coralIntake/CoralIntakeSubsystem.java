...
public class CoralIntakeSubsystem extends SubsystemBase {
  ...
  public Command coralIntakeFast() {
    return this.startEnd(() -> setMotors(.4), () -> setMotors(0));
  }
  ...
  public Command coralIntakeWithLimit() {
    return this.runEnd(() -> setMotorsWithLimit(.2), () -> setMotorsWithLimit(0));
  }

  public Command coralIntakeFastWithLimit() {
    return this.runEnd(() -> setMotorsWithLimit(.5), () -> setMotorsWithLimit(0));
  }
